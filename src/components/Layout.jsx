...
const navigation = [
  {
    ...
    links: [
        ...
        },
        {
            ...
            href: '/books/the-adventure-of-the-mazarin-stone'
        },
        {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center flex-grow basis-0">
        <Link href="/" aria-label="Home" className="inline text-2xl tracking-tight text-transparent bg-gradient-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display">
